<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login1.aspx.cs" Inherits="web_login1" %>
	...
	<div class="container">
		...
		<h2>Login</h2>
			...
			<div>
				...
				<a class="forgot" href="cc.aspx">Create account</a>
				<asp:Button runat="server" type="submit" value="Login" Text="Login" ID="clk" OnClick="clk_Click" /> 
            <br />
